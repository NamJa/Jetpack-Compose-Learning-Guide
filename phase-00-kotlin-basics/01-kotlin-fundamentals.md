...
//sampleStart
    ...
    println("name=$name, age=$age, count=$count, pi=$pi")
//sampleEnd
}
```
...
//sampleStart
    ...
    println("score=$score, distance=$distance, isActive=$isActive, initial=$initial, message=$message")
//sampleEnd
}
```
...
//sampleStart
    ...
    println("longValue=$longValue, doubleValue=$doubleValue, stringValue=$stringValue")
//sampleEnd
}
```
...
//sampleStart
    ...
    val dog = Dog("바둑이")
    val cat = Cat("나비")
    println("${dog.name}: ${dog.sound()}")  // 바둑이: 멍멍!
    println("${cat.name}: ${cat.sound()}")  // 나비: 야옹~
//sampleEnd
}
```
...
//sampleStart
    ...
    // copy()를 활용한 상태 업데이트 예시
    val state = LoginUiState()
    val updated = state.copy(email = "user@example.com")
    println(updated)
//sampleEnd
}
```
...
//sampleStart
    ...
    // when과 함께 사용
    println(describe(Direction.NORTH))  // 북쪽
    println(describe(Direction.WEST))   // 서쪽
//sampleEnd
}
```
...
//sampleStart
    ...
    println("name=$name, nullableName=$nullableName")
//sampleEnd
}
```
...
//sampleStart
    ...
    println("length=$length, displayName=$displayName")
